...
def parse_args():
    ...
    parser.add_argument("--timeout", default=57600, type=int, help="Duration of the job")
    ...
    parser.add_argument('--print_freq', default=10000, type=int, help="the print frequency of training process")
...
def get_shared_folder() -> Path:
    ...
    if Path("checkpoint/").is_dir():
        #p = Path(f"/volume/AudioMAE-main/checkpoint/{user}/bird_pretraining")
        p = Path(f"/workspace/AudioMAE-TE/checkpoint/{user}/bird_pretraining")
