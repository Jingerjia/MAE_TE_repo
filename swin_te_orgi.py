...
class WindowMultiHeadAttention(nn.Module):
    ...
    def __init__(
        ...
        self.qkv = te.Linear(in_features=dim, out_features=dim * 3, bias=True)
        self.attn_drop = nn.Dropout(drop_attn)
        self.proj = te.Linear(in_features=dim, out_features=dim, bias=True)
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        sequential_attn: bool = False,
        norm_layer: Type[nn.Module] = te.LayerNorm,
    ) -> None:
